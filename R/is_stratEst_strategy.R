...
#' @return \code{is.stratEst.strategy} returns \code{TRUE} if its argument is a \code{stratEst.strategy} object (that is, has "stratEst.strategy" amongst its classes) and \code{FALSE} otherwise.
#' @export
