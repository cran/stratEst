...
#' @return \code{is.stratEst.data} returns \code{TRUE} if its argument is a \code{stratEst.data} object (that is, has "stratEst.data" among its classes) and \code{FALSE} otherwise.
#' @export
