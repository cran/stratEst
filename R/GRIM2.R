#' GRIM2
#'
#' Matrix representation of the prisoner's dilemma strategy which plays C until 2 consecutive rounds occur in which either player played D, then play D forever.
#'
