...
#' @return \code{is.stratEst.model} returns \code{TRUE} if its argument is a \code{stratEst.model} object (that is, has "stratEst.model" amongst its classes) and \code{FALSE} otherwise.
#' @export
