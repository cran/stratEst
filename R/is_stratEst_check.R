...
#' @return \code{is.stratEst.check} returns \code{TRUE} if its argument is a \code{stratEst.check} object (that is, has "stratEst.check" amongst its classes) and \code{FALSE} otherwise.
#' @export
